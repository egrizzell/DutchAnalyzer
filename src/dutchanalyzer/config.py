...
EEF_FOLDER = WIKT_CLEANING_DIR / 'EEF' 
ENF_FOLDER = WIKT_CLEANING_DIR / 'ENF' 
EOF_FOLDER = WIKT_CLEANING_DIR / 'EOF'
NEF_FOLDER = WIKT_CLEANING_DIR / 'NEF' 
NNF_FOLDER = WIKT_CLEANING_DIR / 'NNF' 
NOF_FOLDER = WIKT_CLEANING_DIR / 'NOF'


EEF_FILE = EEF_FOLDER / 'EEF.jsonl'
ENF_FILE = ENF_FOLDER / 'ENF.jsonl'
NEF_FILE = NEF_FOLDER / 'NEF.jsonl'
NNF_FILE = NNF_FOLDER / 'NNF.jsonl'
NOF_FILE = NOF_FOLDER / 'NOF.jsonl'
EOF_FILE = EOF_FOLDER / 'EOF.jsonl'
try:
